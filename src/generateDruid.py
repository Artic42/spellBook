...
if __name__ == "__main__":
    ...
    file = AFU.FileIO("template/druidTemplate.tex", readIt=True)
    file.path = "druid.tex"
    ...
    for spell in metaData:
        if "Druid" in metaData[spell]["Classes"] and metaData[spell]["Level"] == "Cantrip":
    ...
    for i in range(1, 6):
        ...
        artificerSpells = {}
        for spell in metaData:
            if "Druid" in metaData[spell]["Classes"] and metaData[spell]["Level"] == i:
